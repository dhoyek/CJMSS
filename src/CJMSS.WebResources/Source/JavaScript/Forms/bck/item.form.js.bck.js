...
var PDG = PDG || {};
PDG.Item = {
    // HTML WebResource control IDs expected on the form (optional)
    WR_IDS: {
    ...
    // --- HTML WebResource helpers (shared pattern with inventory form) ---
    ...
    // Optional KPI web resource (Stock Bar) for Item form
    ...
    // Auto-calc volume (same as inventory)
